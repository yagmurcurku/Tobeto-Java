...
import workshop27102023.core.logging.FileLogger;
import workshop27102023.core.logging.Logger;
import workshop27102023.core.logging.MailLogger;
import workshop27102023.dataAccess.HibernateCarDao;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Car car5 = new Car(7, "Mercedes", 1750000);
