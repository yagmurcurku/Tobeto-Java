...
public class Main {
	...
	public static void main(String[] args) {
		...
		individualCustomer.setFirstName("Yağmur");
		individualCustomer.setLastName("Çurku");
		
		CorporateCustomer corporateCustomer = new CorporateCustomer();
		corporateCustomer.setId(2);
		corporateCustomer.setPhone("01112223344");
		...
		//individualCustomer & corporateCustomer "Customer" tipinde olduğu için bu Array'e atanabilirler.
